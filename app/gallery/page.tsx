    ...
    <div className="bg-light py-5">
      <Container>
        <div className="text-center mb-5">
          <Badge bg="primary" className="mb-3 fs-6 px-3 py-2">Galeri</Badge>
          <h1 className="display-4 fw-bold text-dark mb-4">
            <FaImages className="me-3 text-primary" />
            Çalışmalarımızdan Görüntüler
          </h1>
          <p className="lead text-muted mx-auto" style={{maxWidth: '600px'}}>
            Profesyonel nakliye hizmetlerimizden örnekler ve müşteri memnuniyetimize ilişkin görseller.
          </p>
        </div>
        ...
        <Row className="g-4">
          {galleryImages.map((image) => (
            <Col key={image.id} xs={12} sm={6} md={4} lg={3}>
              <Card className="border-0 shadow-sm h-100 gallery-card" style={{ cursor: 'pointer' }}>
                <div 
                ...
                >
                  ...
                  <div className="gallery-overlay position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center justify-content-center">
                    <FaCamera className="text-white fs-1 opacity-0" style={{ transition: 'opacity 0.3s ease' }} />
                  </div>
                </div>
              </Card>
            </Col>
            ...
            <Card className="border-0 shadow-sm">
              <Card.Body className="p-4 text-center">
                ...
                <p className="text-muted mb-0">
                  Her projemizde müşteri memnuniyetini ön planda tutarak, 
                  en yüksek kalite standartlarında hizmet sunuyoruz. 
                  Galerimizdeki görüntüler, başarılı projelerimizin sadece bir kısmını yansıtmaktadır.
                </p>
              </Card.Body>
            </Card>
          </Col>
